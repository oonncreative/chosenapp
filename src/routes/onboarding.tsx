...
function Onboarding() {
  ...
  return (
    <div className="flex h-screen flex-col items-center justify-center bg-background px-8 text-center transition-colors duration-700 overflow-hidden">
        ...
        <div className="flex-1 flex flex-col items-center justify-center gap-8">
          ...
          {step === 1 && (
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-700 flex flex-col items-center gap-4">
              <h1 className="text-[11px] font-bold tracking-[0.4em] text-foreground uppercase">Ressoa</h1>
              <p className="text-lg text-foreground/60 font-light tracking-tight italic">Inspire-se nas palavras de Deus</p>
            </div>
          )}
          ...
          {step === 3 && (
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-700 flex flex-col items-center gap-4 px-4">
              ...
              <Button 
                variant="outline" 
                className="mt-6 h-[60px] w-full rounded-[24px] border-2 border-foreground bg-background text-lg font-black tracking-tighter text-foreground hover:bg-accent uppercase italic transition-all active:scale-95 shadow-none"
                onClick={async () => {

...
export const MENSAGENS: Record<Categoria, Mensagem[]> = {
  "Feliz": [
    ...
    { id: "f6", tipo: "versiculo", texto: "A alegria do Senhor é a vossa força.", referencia: "Neemias 8:10", resumo: "No contexto da reconstrução dos muros de Jerusalém, o povo estava triste ao ouvir a Lei. Neemias os lembrou que a alegria baseada no caráter de Deus provê energia e vigor para enfrentar as dificuldades. Não é uma alegria emocional passageira, mas um sustento espiritual profundo que nos mantém de pé." },
    { id: "f7", tipo: "salmo", texto: "Pois tu, Senhor, me alegraste pelos teus feitos; exultarei nas obras das tuas mãos.", referencia: "Salmos 92:4", resumo: "Este salmo foca na observação da criação e das ações de Deus na história. A alegria aqui nasce do reconhecimento da soberania divina e do cuidado nos detalhes. Ao olharmos para o que Deus já fez, ganhamos confiança e alegria para o que Ele ainda fará em nossas vidas." },
    { id: "f8", tipo: "versiculo", texto: "Alegrai-vos na esperança, sede pacientes na tribulação, perseverai na oração.", referencia: "Romanos 12:12", resumo: "Paulo apresenta um tripé para a vida cristã onde a alegria está ligada à esperança futura. Mesmo em momentos difíceis (tribulação), a esperança nas promessas de Deus permite que o coração mantenha uma chama de alegria acesa, alimentada por uma vida constante de oração." },
    { id: "f9", tipo: "salmo", texto: "Servi ao Senhor com alegria; apresentai-vos a ele com cântico.", referencia: "Salmos 100:2", resumo: "Um convite à adoração que deve transbordar de felicidade. O salmista entende que Deus não deseja um serviço por obrigação ou fardo, mas um relacionamento onde o prazer de estar em Sua presença se manifeste em canções e gratidão espontânea." },
    { id: "f10", tipo: "versiculo", texto: "Até agora nada pedistes em meu nome; pedi, e recebereis, para que a vossa alegria seja completa.", referencia: "João 16:24", resumo: "Jesus encoraja os discípulos a pedirem ao Pai em Seu nome. Ele revela que Deus deseja nos abençoar de forma que nossa alegria não seja apenas parcial ou momentânea, mas cheia e transbordante, fruto de uma vida de oração respondida." },
  ],
  "Ansioso": [
    { id: "a1", tipo: "versiculo", texto: "Não andem ansiosos por coisa alguma, mas em tudo apresentem seus pedidos a Deus.", referencia: "Filipenses 4:6", resumo: "Paulo ensina que a oração com gratidão é o antídoto para a ansiedade, trazendo a paz que excede o entendimento. Em vez de permitir que as preocupações dominem sua mente, o cristão é chamado a transferir esse peso para Deus através do diálogo constante. Quando agradecemos enquanto pedimos, demonstramos confiança de que o Senhor já está cuidando do nosso futuro." },
    { id: "a2", tipo: "versiculo", texto: "Lancem sobre ele toda a sua ansiedade, porque ele tem cuidado de vocês.", referencia: "1 Pedro 5:7", resumo: "Pedro encoraja os cristãos a confiarem no cuidado pessoal de Deus, transferindo suas preocupações para Aquele que pode resolvê-las. A imagem aqui é de alguém jogando um fardo pesado para outra pessoa mais forte. Deus não apenas observa nossa luta de longe; Ele se importa profundamente com os detalhes da nossa vida e está pronto para carregar o peso que nos cansa." },
    { id: "a4", tipo: "salmo", texto: "Quando a ansiedade já me dominava, o teu consolo trouxe alívio à minha alma.", referencia: "Salmos 94:19", resumo: "Um salmo que reconhece a realidade das lutas internas, mas aponta para o conforto divino como a fonte de renovação mental. Mesmo quando os pensamentos se tornam barulhentos e caóticos dentro de nós, o Espírito Santo tem o poder de sussurrar verdades que acalmam a tempestade. O alívio não vem da ausência de problemas, mas da presença consoladora do Pai." },
    { id: "a5", tipo: "versiculo", texto: "Quem de vocês, por mais que se preocupe, pode acrescentar uma hora que seja à sua vida?", referencia: "Mateus 6:27", resumo: "Palavras de Jesus no Sermão do Monte, lembrando que a preocupação é ineficaz e que devemos confiar na providência diária. Jesus usa a lógica para nos mostrar que a ansiedade não resolve nada; ela apenas rouba nossa energia de hoje. Ao focarmos na soberania de Deus sobre o tempo, percebemos que podemos descansar sob Seu cuidado protetor." },
  ],
  "Triste": [
